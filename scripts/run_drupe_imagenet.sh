...
python /media/lambda/SSD1/nhat/lorex/main.py \
  ...
  --attack_ckpt_path /media/lambda/SSD1/nhat/DRUPE/DRUPE_results/drupe/CLIP_100/downstream_cifar10_t0/epoch100.pth \
  --trigger_path /media/lambda/SSD1/nhat/DRUPE/trigger/trigger_pt_white_185_24.npz \
