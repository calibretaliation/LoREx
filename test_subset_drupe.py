import sys, os, torch
from experiment_lorex_aug_comprehensive import load_attack, build_test_dataset, extract_test_features, score_lorex_aug, precompute_lorex_aug_stats, ATTACK_CONFIGS, build_trusted_loader, BATCH_SIZE, NUM_WORKERS, SEED, DATA_ROOT, extract_features

device = torch.device('cuda')

# Test DRUPE-SimCLR
cfg = next(c for c in ATTACK_CONFIGS if c['name'] == 'DRUPE-SimCLR')
